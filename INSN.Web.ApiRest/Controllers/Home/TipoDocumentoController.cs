...
namespace INSN.Web.ApiRest.Controllers.SegApp.Mantenimiento
{
    ...
    public class TipoDocumentoController : ControllerBase
    {
        ...
        [ProducesResponseType((int)StatusCodes.Status200OK, Type = typeof(BaseResponseGeneric<ICollection<TipoDocumentoDtoResponse>>))]
        [ProducesResponseType((int)StatusCodes.Status400BadRequest, Type = typeof(BaseResponseGeneric<ICollection<TipoDocumentoDtoResponse>>))]

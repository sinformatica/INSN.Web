...
public class OportunidadLaboralController : Controller
{
  ...
  //  private readonly ITipoDocumentoProxy _TipoDocumentoProxy;
    ...
    public OportunidadLaboralController(//IDocumentoLegalProxy proxy, ITipoDocumentoProxy TipoDocumentoProxy,
        ILogger<OportunidadLaboralController> logger, IWebHostEnvironment env)
    {
       // _proxy = proxy;
    ...
    {
        return View("~/Views/Home/OportunidadLaboral/Index.cshtml");
    }

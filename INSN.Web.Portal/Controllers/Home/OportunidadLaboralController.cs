...
public class OportunidadLaboralController : Controller
{
    ...
    public OportunidadLaboralController(IDocumentoLegalProxy proxy, ITipoDocumentoProxy TipoDocumentoProxy, ILogger<OportunidadLaboralController> logger, IWebHostEnvironment env)
    {
        _proxy = proxy;

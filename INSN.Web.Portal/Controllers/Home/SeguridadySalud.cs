...
public class SeguridadySalud : Controller
{
  ...
  //  private readonly ITipoDocumentoProxy _TipoDocumentoProxy;
    ...
    public SeguridadySalud(//IDocumentoLegalProxy proxy, ITipoDocumentoProxy TipoDocumentoProxy,
        ILogger<SeguridadySalud> logger, IWebHostEnvironment env)
    {
       // _proxy = proxy;
    ...
    {
        return View("~/Views/Home/SeguridadySalud/Index.cshtml");
    }

...
public class DocenciaController : Controller
{
  ...
  //  private readonly ITipoDocumentoProxy _TipoDocumentoProxy;
    ...
    public DocenciaController(//IDocumentoLegalProxy proxy, ITipoDocumentoProxy TipoDocumentoProxy,
        ILogger<DocenciaController> logger, IWebHostEnvironment env)
    {
       // _proxy = proxy;
    ...
    {
        return View("~/Views/Home/Docencia/Index.cshtml");
    }

...
public class ExploracionController : Controller
{
  ...
  //  private readonly ITipoDocumentoProxy _TipoDocumentoProxy;
    private readonly ILogger<ExploracionController> _logger;
    ...
    public ExploracionController(//IDocumentoLegalProxy proxy, ITipoDocumentoProxy TipoDocumentoProxy,
        ILogger<ExploracionController> logger, IWebHostEnvironment env)
    {
       // _proxy = proxy;
    ...
    {
        return View("~/Views/Home/Exploracion/Index.cshtml");
    }

...
public class SeguridadySaludController : Controller
{
    ...
    /// <summary>
    /// Seguridad y Salud Controller
    /// </summary>
    /// <param name="proxy"></param>
    /// <param name="TipoDocumentoProxy"></param>
    public SeguridadySaludController(IDocumentoLegalProxy proxy, ITipoDocumentoProxy TipoDocumentoProxy)
    {
        _proxy = proxy;

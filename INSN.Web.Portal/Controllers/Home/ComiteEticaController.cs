...
public class ComiteEticaController : Controller
{
  ...
  //  private readonly ITipoDocumentoProxy _TipoDocumentoProxy;
    ...
    public ComiteEticaController(//IDocumentoLegalProxy proxy, ITipoDocumentoProxy TipoDocumentoProxy,
        ILogger<ComiteEticaController> logger, IWebHostEnvironment env)
    {
       // _proxy = proxy;
    ...
    {
        return View("~/Views/Home/ComiteEtica/Index.cshtml");
    }

...
namespace INSN.Web.Repositories.Implementaciones.Home.OportunidadLaboral
{
    ...
    /// </summary>
    public class ConvocatoriaRepository : RepositoryBase<DocumentoConvocatoria>, IConvocatoriaRepository
    {
        /// <summary>
        /// INSNWebDBContext
        /// </summary>
        /// <param name="context"></param>
        public ConvocatoriaRepository(INSNWebDBContext context) : base(context)
        {
        }
